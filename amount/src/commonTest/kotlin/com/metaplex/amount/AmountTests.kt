...
class AmountTests {
    ...
    fun testFormatting() {
        ...
        val solAmountLeadingZeroDecimal = createAmount(2_005_000_000, "SOL", 9)
        ...
        assertEquals("2.005000000", amountToString(solAmountLeadingZeroDecimal))
        assertEquals("SOL 2.005000000", displayAmount(solAmountLeadingZeroDecimal))
    }
    ...
    fun testAddAndSubtractAmounts() {
        ...
        amountEquals(subtractAmounts(a, sol(1)), "SOL 0.500000000")
    }
    ...
    fun testMultiplyAndDivideAmounts() {
        amountEquals(multiplyAmount(sol(1.5), 3), "SOL 4.500000000")
        amountEquals(multiplyAmount(sol(1.5), 3.78), "SOL 5.670000000")
        amountEquals(multiplyAmount(sol(1.5), -1), "SOL -1.500000000")
        amountEquals(multiplyAmount(sol(1.5), BigInteger(3)), "SOL 4.500000000")

        amountEquals(divideAmount(sol(1.5), 3), "SOL 0.500000000")
        amountEquals(divideAmount(sol(1.5), 9), "SOL 0.166666666")
        amountEquals(divideAmount(sol(1.5), -1), "SOL -1.500000000")
        amountEquals(divideAmount(sol(1.5), BigInteger(9)), "SOL 0.166666666")
    }
    ...
    fun testComparisonWithTolerance() {
        assertFalse(isEqualToAmount(sol(1.5), sol(1.6)))
        assertFalse(isEqualToAmount(sol(1.5), sol(1.6), sol(0.01)))
        assertTrue(isEqualToAmount(sol(1.5), sol(1.6), sol(0.1)))
        assertTrue(isEqualToAmount(sol(1.5), sol(1.6), sol(0.2)))
    }
